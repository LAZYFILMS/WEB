// Cameras shop cart — separate from film store (lf_cart). Same checkout pattern (?lf_cart=) on cameras WooCommerce.
(function () {
    var STORE = 'https://cameras.lazyfilms.in';
    var KEY = 'lf_cart_cameras';
